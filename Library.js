...
`{"story_bible":{${storyCards
    .filter(c => c.type === "Prompt")  // Only include story cards of type "Prompt"
    .map(c => JSON.stringify(           // Convert each card entry to JSON string
            stringToObject(c.entry, true)  // Parse into an object first
